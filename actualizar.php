...
$sql = "UPDATE padres SET nombre1='$nombre1', nombre2='$nombre2', apellido_paterno='$apepat', apellido_materno='$apemat', correo='$correo' , telefono='$telefono' WHERE id_padres=$id";
